...
const evalSpec = JSON.parse(readFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_1168f14f/eval-spec.json', 'utf-8'))
const results = {
  repo: evalSpec.repo,
  rev: evalSpec.rev,
  questions: []
...
writeFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_1168f14f/result.1756927664266.json', JSON.stringify(results, null, 2))
console.log('Results written to benchmark-results/2025-09-03/math_reasoning_Amp Default_1168f14f/result.1756927664266.json')

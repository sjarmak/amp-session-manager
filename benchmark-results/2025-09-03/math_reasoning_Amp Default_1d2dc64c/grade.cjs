...
async function main() {
  const evalResult = JSON.parse(readFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_1d2dc64c/result.1756927495850.json', 'utf-8'))
  ...
  writeFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_1d2dc64c/result.1756927495850-graded.json', JSON.stringify(gradedResult, null, 2))
  console.log('Graded results written to benchmark-results/2025-09-03/math_reasoning_Amp Default_1d2dc64c/result.1756927495850-graded.json')
}

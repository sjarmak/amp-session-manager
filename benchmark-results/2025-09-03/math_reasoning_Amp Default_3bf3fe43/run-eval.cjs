...
const evalSpec = JSON.parse(readFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_3bf3fe43/eval-spec.json', 'utf-8'))
const results = {
  repo: evalSpec.repo,
  rev: evalSpec.rev,
  questions: []
...
for (let i = 0; i < evalSpec.questions.length; i++) {
  ...
  try {
    const ampCommand = ["/Users/sjarmak/amp/cli/dist/main.js","--server","https://localhost:7002"]
...
writeFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_3bf3fe43/result.1756927595189.json', JSON.stringify(results, null, 2))
console.log('Results written to benchmark-results/2025-09-03/math_reasoning_Amp Default_3bf3fe43/result.1756927595189.json')

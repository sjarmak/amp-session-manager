...
async function main() {
  const evalResult = parse(readFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_b41f2425/result.1756925427469.yaml', 'utf-8'))
  ...
  writeFileSync('benchmark-results/2025-09-03/math_reasoning_Amp Default_b41f2425/result.1756925427469-graded.yaml', stringify(gradedResult))
  console.log('Graded results written to benchmark-results/2025-09-03/math_reasoning_Amp Default_b41f2425/result.1756925427469-graded.yaml')
}

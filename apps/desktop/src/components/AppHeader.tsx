...
interface AppHeaderProps {
  ...
  onAmpSettingsClick: () => void;
}

export function AppHeader({ onSettingsClick, onAmpSettingsClick }: AppHeaderProps) {
  return (
    <header className="text-center mb-8 relative app-header">
      ...
      <div className="absolute top-0 right-0 flex gap-2">
        <button
          onClick={onAmpSettingsClick}
          className="p-2 text-gruvbox-light3 hover:text-gruvbox-light1 transition-colors"

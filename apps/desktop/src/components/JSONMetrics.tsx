        ...
        <div className="bg-gruvbox-bg2 border border-gruvbox-bg4 rounded-lg p-4">
          ...
          <div className="space-y-1 text-sm text-gruvbox-fg1">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono text-gruvbox-green">+{apiSummary?.summary?.linesChanged?.added || 0}</span>
            </div>
            <div className="flex justify-between">
              <span>Lines Deleted:</span>
              <span className="font-mono text-gruvbox-red">-{apiSummary?.summary?.linesChanged?.deleted || 0}</span>
            </div>
